walkner-av application is licensed under the Non-Profit Open Software License
...
Third-party acknowledgements:
  ...
  - `client/assets/img/glowing_light_bulb.png` was released into the public domain
    and is available at
