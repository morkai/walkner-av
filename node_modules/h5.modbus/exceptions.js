...
exportError(12,
            'ResponseTimeout',
            'No response was obtained from the slave in the specified time.');

exportError(13,
            'InvalidChecksum',
            'Response obtained from the slave had an invalid checksum.');

exportError(14,
            'InvalidResponseData',
            'Response data obtained from the slave was invalid.');

exportError(15,
            'IncompleteResponseFrame',
            'Response frame obtained from the slave was incomplete.');
