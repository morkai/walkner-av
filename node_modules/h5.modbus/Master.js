...
Master.prototype.setUpOptions = function(options)
{
  ...
  this.requestOnReconnectDelay = checkNumber(options.requestOnReconnectDelay, 1)
    ? options.requestOnReconnectDelay
    : 0;
...
{
  this.requestQueue = this.requestQueue.filter(function(req)
  {
  ...
  setTimeout(
    function()
    {
      ...
      me.executeRunningTransactions();
    },
    this.requestOnReconnectDelay
  );
};
